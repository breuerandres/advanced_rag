...
- Default MVP OpenAI models are `gpt-4.1-nano` for chat and `text-embedding-3-small` for embeddings at `1024` dimensions to reduce cost until the MVP is running end to end. Models remain configurable per deployment.
