        ...
        <form className="dialog-form" noValidate onSubmit={handleSubmit}>
          ...
          <label className="field">
            ...
            <UnitTreeSelect
              ...
              onChange={(next) => setOwnerUnitId(next === NONE_UNIT_VALUE ? '' : next)}
              disabled={isSaving}
              units={organizationalUnits}
              companyWideLabel={t('orgUnits.company_wide')}
              leadingOptions={[{ value: NONE_UNIT_VALUE, label: t('users.owner_unit_none') }]}
            />
          </label>
          ...
          <div className="dialog-grid">
            ...
            <label className="field">
              ...
              <UnitTreeSelect
                ...
                onChange={setOrganizationalUnitId}
                disabled={isSaving}
                units={organizationalUnits}
                companyWideLabel="toda la empresa"
              />
            </label>
...
// The optional "no owner unit" choice maps to a sentinel value because the unit
// tree itself only holds real unit ids.
