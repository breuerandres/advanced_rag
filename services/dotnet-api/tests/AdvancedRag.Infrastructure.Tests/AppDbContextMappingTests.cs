...
public sealed class AppDbContextMappingTests
{
    private static readonly IReadOnlyDictionary<Type, string> ExpectedTables = new Dictionary<Type, string>
    {
        ...
        [typeof(Instruction)] = "instructions",
        [typeof(InstructionVersion)] = "instruction_versions",
        [typeof(InstructionPermission)] = "instruction_permissions",
        [typeof(InstructionTag)] = "instruction_tags",
